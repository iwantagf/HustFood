    ...
    <main>
      ...
      <div className={styles.successContainer}>
        ...
        <p className={styles.successDesc}>
          Cảm ơn bạn đã đặt hàng tại HustFood. Đơn hàng của bạn đã được tiếp nhận và đang được bếp chuẩn bị. Shipper sẽ liên hệ với bạn trong thời gian sớm nhất. Chúc bạn có một bữa ăn ngon miệng!
        </p>
